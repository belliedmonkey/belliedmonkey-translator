...
${cell('④ 允许了', '开关变绿；下一次按快捷键就生效。', swRow(true, '已允许 · 选中文字后直接按 ⌃⌥T'))}
...
${cell(`系统的「剪贴板隐私」提示 ${pend('T2')}`, '较新的 macOS 在程序读剪贴板时可能弹系统提示。目前不是默认开；若将来默认开，这一支就是用户会看到的。', `<div style="display:flex; flex-direction:column; gap:12px; align-items:flex-start">${sys('「大肚猴翻译」想要粘贴', '允许后，它可以读取你拷贝的内容。', '不允许', '允许粘贴')}<div class="note" style="font-size:.82rem">设置块里提前说一句：「较新的系统可能会再问一次『允许粘贴』—— 选『允许』后不再问。」</div></div>`)}
`)}`, { page: PG });
...
${cell('④ 识别中', '面板立刻出现在选区旁，来源标签「截图」。', panel({ tag: '截图', lang: null, src: null, body: `<div style="display:flex; flex-direction:column; gap:8px; padding:4px 2px"><div class="sk" style="width:90%"></div><div class="sk" style="width:58%"></div></div><div class="mini">正在本机识别文字…</div>`, foot: null, width: 300 }))}
