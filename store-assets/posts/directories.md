...
每一项都是表单，可以由我填到提交前一步；提交键由人点。**文案统一用下面这一段**，
不同站只改长度。
...
| 站 | 入口 | 备注 |
|---|---|---|
| AlternativeTo | https://alternativeto.net/manage-item/ | 提交后**去 Immersive Translate 的页面点「Suggest alternative」**挂上去 —— 这是流量来源，不是自己的条目 |
| OpenAlternative | https://openalternative.co/submit | 要 GitHub 仓库 URL；开源专属，审核几天 |
| Product Hunt | https://www.producthunt.com/posts/new | 与 Show HN **错开**（PH 要选 launch 日，需要预热；这两天先不做，记着） |
| awesome-safari-extensions | GitHub PR → **`linsa-io/safari-extensions`**（393★，2026-08 仍在更新；`gh search repos` 2026-09-10 取的） | 按其格式加一行，挂 Translation 类 |
| awesome-browser-extensions | —— **2026-09-10 查过：没有通用的高星「awesome browser extensions」清单**（命中的是 GitHub 专用 / OSINT 专用），不硬凑 | — |
| awesome-language-learning | GitHub PR → **`Vuizur/awesome-language-learning`**（208★，2026-09 仍在更新） | 挂 tools / browser extensions 段 |
